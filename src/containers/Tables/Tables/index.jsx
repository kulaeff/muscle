...
/**
 * TablesTables container
 * @class
 */
class TablesTables extends Component {
    /**
     * TablesTables container properties
     * @static
    ...
    /**
     * Creates TablesTables container
     * @constructor
     */
    constructor(props) {
    ...
    componentDidMount() {
        const
            { params } = this.props,
            { getTablesTables } = this.props.tablesActions

        getTablesTables(params.database, this.state.filter)
    }
    ...
    componentWillReceiveProps(nextProps) {
        const
            ...
            { getTablesTables, restoreWindow } = this.props.tablesActions
        ...
        if (params.database !== nextProps.params.database) {
            ...
            getTablesTables(nextProps.params.database, this.state.filter)
    ...
    debouncedTextboxFilterChange = (token) => {
        ...
        getTablesTables(params.database, token)
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(TablesTables)